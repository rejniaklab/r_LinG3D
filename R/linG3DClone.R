...
#'
#' @details This code generates the 3D lineage tree of all cells from one
...
#'
#'   EXAMPLE 3
#'   linG3DClone(pathData="exampleExp",  cloneNum=10, IsGradient=0,
...
linG3DClone <- function(pathData, cloneNum, IsGradient,
  ...
  # run the for loop to find Nmatrix
