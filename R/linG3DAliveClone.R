...
#'
#' @details This code generates the 3D lineage tree of one clone of number
...
#' @param cloneNum  -- clone number to be drawn
...
#'   linG3DAliveClone(pathData="exampleB05", cloneNum=3, IsGradient=1,
